...
|----------|-------------|---------|
| `DATA_DIR` | Directory for persistent settings storage | `./data` |
| `EDIT_MODE_PASSWORD` | Password for accessing edit mode | Required |
| `TOTP_SECRET` | Base32 secret for 2FA (optional, enables 2FA when set) | - |
| `TOTP_ISSUER` | Name shown in authenticator app | `TRONLinkHub` |
